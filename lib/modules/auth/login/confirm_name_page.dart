...
import 'package:test_vibe/modules/auth/login/widgets/confirm_profile_page_params.dart';
...
class ConfirmNamePage extends StatefulWidget {
  const ConfirmNamePage({
    super.key,
    required this.params,
  });

  final ConfirmNamePageParams params;

  @override
  State<ConfirmNamePage> createState() => _LoginPageState();
}

class _LoginPageState extends State<ConfirmNamePage> {
  ...
  void initState() {
    super.initState();
    countryNotifier = ValueNotifier(widget.params.country);
    NameController = TextEditingController();
    phoneController = TextEditingController(text: widget.params.phone);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    PhoneField(
                      ...
                      enable: false,
                      userCountry: widget.params.country,
                    ),
                        ...
                        return CustomElevatedButton(
                          ...
                          onPressed: () {
                            if (_formKey.currentState?.validate() ?? false) {
                              final phone = '${widget.params.country.phoneCode}${phoneController.text}';
                              context.read<LoginBloc>().confirmProfile(
